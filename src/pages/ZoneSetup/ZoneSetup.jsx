    ...
    <div className="ZN-zone-list-container">
      <div className="ZN-zone-list">
        ...
        <div className="ZN-zone-list-search">
          <input type="text" placeholder="Search" className="ZN-search-input" />
          <button className="ZN-search-button">Search</button>
        </div>
        ...
        <div className="ZN-pagination">
          <button className="ZN-page-button">Previous</button>
          {[1, 2, 3, 4, 5, 6].map((page) => (
            <button
              key={page}
              className={`ZN-page-number ${page === 1 ? "active" : ""}`}
            >
              {page}
            </button>
          ))}
          <button className="ZN-page-button">Next</button>
        </div>
      </div>
    </div>
  </div>
